...
Use [CLI Knowledge Mining](./06-knowledge-mining-studio.md) for serial document windows, LLM Wiki compilation, task tracking, checkpoint recovery, and log inspection.
