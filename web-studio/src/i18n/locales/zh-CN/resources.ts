const resources = {
  ...
  addResource: {
    ...
    sourceKind: {
      ...
      git: 'Git 仓库',
      gitHint: '支持公开或私有 Git 仓库，并可指定分支或 Commit。',
      remoteFile: '远程文件',
    ...
    feishu: {
      auth: {
        ...
        user: '用户授权',
        userHint: '使用当前用户的飞书 Access Token 访问私有文档。',
      },
      accessToken: 'Access Token',
      'accessToken.placeholder': 'u-...',
      'accessToken.hint': 'Token 仅用于本次导入，不会保存。',
      refreshToken: 'Refresh Token',
      'refreshToken.placeholder': 'r-...',
      'refreshToken.hint':
        '定时同步需要 Refresh Token；服务端还需配置签发该 Token 的同一个飞书应用。',
      configuration: {
    ...
    git: {
      ...
      commit: 'Commit',
      'commit.placeholder': '完整或短 Commit SHA',
      auth: {
        title: '仓库访问方式',
        public: '公开仓库',
        ...
        httpsOnly: 'Token 认证仅支持 HTTPS Git 地址。',
      },
      username: '用户名',
      ...
      'token.hint':
        '凭证通过请求体发送；开启定时同步后会保存到 Watch 私有鉴权状态。',
    },
    web: {
      mode: {
        title: '导入方式',
